!function(){
	...
	t.prototype={
		...
		start:function(t){
			var e=this,s=this.ele.getElementsByClassName("ft-slider-bg")[0];
			t.addEventListener("touchstart",function(t){
				this.className="ft-slider-bar",
		...
		move:function(t){
			if(!this.isDrag){
				...
				t.addEventListener("touchmove",function(t){
					var i=t.touches[0].clientX-e.strartX,
						n=e.opts.width-e.opts.height;
					i=i>n?n:i,
						this.style.transform="translate3d("+i+"px,0,0)",
						s.style.width=i+"px",
						t.preventDefault()
				},!1)
			}
			...
			if(!this.isDrag){
				var e=this,
					...
					i=this.ele.getElementsByClassName("ft-slider-content")[0],
					s=this.ele.getElementsByClassName("ft-slider-bg")[0];
				t.addEventListener("touchend",function(t){
					var n=e.opts,
						a=n.callback,
						l=t.changedTouches[0].clientX-e.strartX,
						r=n.width-n.height,
						d=0,
						h=!1;
					l>=r&&(d=r,i.textContent=n.successMsg,this.className=this.className+=" success",i.className="ft-slider-content success",h=!0),
						this.className=h?"ft-slider-bar success transition":"ft-slider-bar transition",
						s.className="ft-slider-bg transition",
						s.style.width=d+"px",
						this.style.transform="translate3d("+d+"px,0,0)",
						a&&a(h),
						t.preventDefault()
				},!1)
			}
